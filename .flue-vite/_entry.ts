...
const workflowExtension0 = resolveCloudflareExtension(workflowModules["hello"], "hello", 'Workflow');
const FlueHelloWorkflow = class FlueHelloWorkflow extends workflowExtension0.base(Agent) {
  async onRequest(request) {
    return dispatchWorkflow(request, this, "hello");
  }

  async onFiberRecovered(ctx) {
    if (ctx.name?.startsWith('flue:workflow:')) {
      return handleFlueWorkflowFiberRecovered(ctx, this, "hello");
    }
